        ...
        <div className={classes.login_container}>
          <Card className={classes.login_form}>
            <CardContent>
                ...
                <Typography variant={"h6"} className={classes.login_form_title}>Please get registered your device to use this application</Typography>
    <Typography variant={"h6"} className={classes.login_form_title}>Your device id is {getDeviceId()}</Typography>
